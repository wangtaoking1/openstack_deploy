...
# Install nova
apt-get install -y nova-api nova-cert nova-common nova-conductor nova-consoleauth nova-novncproxy nova-scheduler python-novaclient nova-ajax-console-proxy novnc nova-compute nova-compute-kvm nova-network python-nova python-keystone python-glance python-mysqldb
